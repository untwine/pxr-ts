...
class PxrTsConan(ConanFile):
    name = "pxr-ts"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-ts"
    url = "https://github.com/untwine/pxr-ts"
    description = "Library for time splines used in OpenUSD"
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-ts"]
        self.cpp_info.libs = ["PxrTs"]
