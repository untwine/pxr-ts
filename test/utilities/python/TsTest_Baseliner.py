...
class TsTest_Baseliner:
    ...
    - If there is no baseline file yet, a candidate baseline file will be
      ...
      subdirectory of the test run directory.  (The graph isn't
    ...
    """
    @staticmethod
    def CreateForParamCompare(path, testName, splineData, samples, precision = 6):
        """
        ...
        return TsTest_Baseliner(
            path, testName, splineData, samples, precision, compareSamples = False)

    @staticmethod
    def CreateForEvalCompare(path, testName, splineData, samples, precision = 6):
        """
        ...
        """
        return TsTest_Baseliner(
            path, testName, splineData, samples, precision, compareSamples = True)
    ...
    def __init__(
            self, path, testName, splineData, samples, precision, compareSamples):
        """
    ...
    def Validate(self):
        ...
        baselinePath = os.path.join(self._path, self._fileName)
    ...
    def _WriteOptionals(self):
        ...
        baselineGraphPath = os.path.join(self._path, self._singleGraphFileName)
