...
class TsTest_Baseliner:
    ...
    """
    @staticmethod
    def CreateForParamCompare(path, testName, spline, samples, precision = 6):
        """
        ...
        return TsTest_Baseliner(
            path, testName, spline, samples, precision, compareSamples = False)

    @staticmethod
    def CreateForEvalCompare(path, testName, spline, samples, precision = 6):
        """
        ...
        """
        return TsTest_Baseliner(
            path, testName, spline, samples, precision, compareSamples = True)
    ...
    def __init__(
            self, path, testName, spline, samples, precision, compareSamples):
        """
